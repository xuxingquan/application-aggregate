...
import com.sankuai.inf.leaf.service.segment.SegmentIDGenImpl;
import com.sankuai.inf.leaf.service.SegmentService;
import com.sankuai.inf.leaf.service.model.SegmentBufferView;
import com.sankuai.inf.leaf.service.segment.model.LeafAlloc;
import com.sankuai.inf.leaf.service.segment.model.SegmentBuffer;
...
public class LeafMonitorController {
    ...
    public String getCache(Model model) {
        ...
        Assert.isTrue(Objects.nonNull(segmentIDGen),"You should config leaf.segment.enable=true first");
